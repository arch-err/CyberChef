...
class HTMLOperation {
    ...
    toFullHtml() {
        ...
        <div class="recip-icons">
            ...
            <button type="button" class="material-icons operation-action duplicate-operation" aria-label="Duplicate operation" title="Duplicate operation">content_copy</button>
            <button type="button" class="material-icons operation-action remove-operation" aria-label="Remove operation" title="Remove operation">delete_outline</button>
        </div>
